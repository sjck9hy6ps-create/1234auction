...
// [2026-07-18] shared.mjs(아파트/전세 수집 담당)의 LAWD_CODES를 기준으로
// 통일했습니다. shared.mjs가 최근 행정개편(2026-07-01 전남광주통합특별시
// 출범, 2023 대구 군위군 편입, 인천 구 개편)까지 반영된 가장 최신 자료였고,
// 이 파일이 예전에 쓰던 자료는 이런 개편 이전 상태라 오래되고 부정확했습니다.
// 다구(多區) 도시 표기도 shared.mjs 관례(예: '경기 수원 장안구', '시' 없음)를
// 그대로 따릅니다 — 수집·표시 전체에서 지역명 표기를 일치시켜야 하기 때문입니다.
// lawd-codes.mjs와 완전히 동일한 배열입니다.
export const LAWD_CODES = [
  ...
  { code: '28275', name: '인천 서해구' },
  { code: '28290', name: '인천 검단구' },
  ...
  { code: '41192', name: '경기 부천시' }, // 원미구
  { code: '41194', name: '경기 부천시' }, // 소사구
  { code: '41196', name: '경기 부천시' }, // 오정구
  ...
  { code: '12110', name: '전남광주 목포시' },
  { code: '12130', name: '전남광주 여수시' },
  { code: '12150', name: '전남광주 순천시' },
  { code: '12170', name: '전남광주 나주시' },
  { code: '12190', name: '전남광주 광양시' },
  { code: '12210', name: '전남광주 동구' },
  { code: '12240', name: '전남광주 서구' },
  { code: '12270', name: '전남광주 남구' },
  { code: '12300', name: '전남광주 북구' },
  { code: '12330', name: '전남광주 광산구' },
  { code: '12710', name: '전남광주 담양군' },
  { code: '12720', name: '전남광주 곡성군' },
  { code: '12730', name: '전남광주 구례군' },
  { code: '12740', name: '전남광주 고흥군' },
  { code: '12750', name: '전남광주 보성군' },
  { code: '12760', name: '전남광주 화순군' },
  { code: '12770', name: '전남광주 장흥군' },
  { code: '12780', name: '전남광주 강진군' },
  { code: '12790', name: '전남광주 해남군' },
  { code: '12800', name: '전남광주 영암군' },
  { code: '12810', name: '전남광주 무안군' },
  { code: '12820', name: '전남광주 함평군' },
  { code: '12830', name: '전남광주 영광군' },
  { code: '12840', name: '전남광주 장성군' },
  { code: '12850', name: '전남광주 완도군' },
  { code: '12860', name: '전남광주 진도군' },
