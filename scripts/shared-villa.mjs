...
// [2026-07-18 전체 재검증 완료] data.go.kr 공식 법정동코드(시군구코드) 표와
// 250개 항목 전부를 대조하여 수정했습니다. 기존 배열은 경기도 구리시~여주시
// 구간이 통째로 한 칸씩 밀려 있었고, 수원/성남/안양/안산/청주/천안/전주/포항 등
// 다구(多區) 도시의 구 코드도 밀려 있었으며, 고양 일산동/서구·용인 기흥/수지구·
// 김포시·화성시·창원시 5개 구는 아예 존재하지 않는 코드였습니다.
// (총 250개 중 50개, 20% 오류 — Daum 부동산/부동산114/hogangnono로 교차 검증)
// lawd-codes.mjs와 동일한 배열입니다. 원래 여기 있던 '세종 세종시'는 다른 지역과
// 표기 규칙을 맞춰 '세종'으로 통일했습니다 (읽는 쪽인 get-house.js/index.html이
// 이 값을 그대로 region으로 저장/조회하므로 반드시 일치해야 함).
export const LAWD_CODES = [
  ...
  { code: '41171', name: '경기 안양시 만안구' },
  { code: '41173', name: '경기 안양시 동안구' },
  { code: '41190', name: '경기 부천시' },
  { code: '41210', name: '경기 광명시' },
  { code: '41220', name: '경기 평택시' },
  { code: '41250', name: '경기 동두천시' },
  { code: '41271', name: '경기 안산시 상록구' },
  { code: '41273', name: '경기 안산시 단원구' },
  ...
  { code: '43111', name: '충북 청주시 상당구' },
  { code: '43112', name: '충북 청주시 서원구' },
  { code: '43113', name: '충북 청주시 흥덕구' },
  { code: '43114', name: '충북 청주시 청원구' },
  ...
  { code: '44131', name: '충남 천안시 동남구' },
  { code: '44133', name: '충남 천안시 서북구' },
  ...
  { code: '45111', name: '전북 전주시 완산구' },
  { code: '45113', name: '전북 전주시 덕진구' },
  ...
  { code: '47111', name: '경북 포항시 남구' },
  { code: '47113', name: '경북 포항시 북구' },
  ...
  { code: '48121', name: '경남 창원시 의창구' },
  { code: '48123', name: '경남 창원시 성산구' },
  { code: '48125', name: '경남 창원시 마산합포구' },
  { code: '48127', name: '경남 창원시 마산회원구' },
  { code: '48129', name: '경남 창원시 진해구' },
